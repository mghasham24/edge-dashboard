    ...
    function buildRow(r, color, isC) {
        ...
        + '<td style="width:24px;padding:0 4px;text-align:center">' + (_rsRowUrl ? '<a href="' + escHtml(_rsRowUrl) + '" target="_blank" rel="noopener" onclick="event.stopPropagation()" title="View on Real Sports" style="display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;color:var(--accent);font-size:13px;text-decoration:none;border:1px solid var(--border2);border-radius:3px;opacity:0.85">↗</a>' : '') + '</td>'
