    ...
    // Country flag images for WC tab (flagcdn.com, ISO 3166-1 alpha-2)
    var WC_FLAG_URLS = {
    ...
    function teamLogoHtml(name, size) {
        ...
        var isFlag = false;
        if (!url) { url = cleanName && WC_FLAG_URLS[cleanName]; if (url) isFlag = true; }
        var s = size || 18;
        ...
        if (isFlag) {
            var fim = 'height:' + s + 'px;width:auto;max-width:' + Math.round(s * 1.6) + 'px;border-radius:3px;object-fit:cover;flex-shrink:0;vertical-align:middle';
            return '<img src="' + url + '" style="' + fim + '" onerror="this.style.display=\'none\';this.nextElementSibling.style.display=\'inline-flex\'" alt=""><span style="' + fb + ';display:none">' + letter + '</span>';
        }
