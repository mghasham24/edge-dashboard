    ...
    function buildRow(r, color, isC) {
        ...
        + '<td style="width:26px;padding:0 3px;text-align:center">' + (_rsRowUrl ? '<a href="' + escHtml(_rsRowUrl) + '" target="_blank" rel="noopener" onclick="event.stopPropagation()" title="View on Real Sports" style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;color:var(--accent);text-decoration:none;border:1px solid var(--border2);border-radius:4px;opacity:0.85"><svg viewBox="0 0 20 22" fill="currentColor" aria-hidden="true" style="width:12px;height:13px;display:block"><path fill-rule="evenodd" d="M2 0h12l4 3v7l-4 3h-4l6 9h-4L6 13v9H2V0zM6 3v7h7l2-1V5l-2-2H6z"/></svg></a>' : '') + '</td>'
