...
// GET /api/fd/ufc — DK native UFC moneylines (main card)
// Pro-only. Single controldata request — same pattern as dk/nbaalts.js.

import { getSessionOrCron } from '../../_lib/auth.js';

const DK_LEAGUE_ID = '9034';   // UFC main card
const DK_SUBCAT_ID = '13025';  // MMA featured subcat
const CACHE_KEY    = 'dk_ufc';
const CACHE_TTL    = 30;
