...
const MIN_EV             = parseFloat(process.env.MIN_EV              || '12.5');  // WS payout EV gate
const LIVE_MIN_EV        = parseFloat(process.env.LIVE_MIN_EV         || '12.5');  // floor for live RS + slippage checks
const PRE_FILTER_EV      = parseFloat(process.env.PRE_FILTER_EV       || '10');    // traditional-formula pre-filter
const MAX_POSTS          = parseInt(process.env.MAX_POSTS              || '5');
const POST_DELAY_MS      = parseInt(process.env.POST_DELAY_MS          || '5000');
const REPOST_EV_JUMP     = parseFloat(process.env.REPOST_EV_JUMP       || '10');
const REPOST_COOLDOWN_MS = parseInt(process.env.REPOST_COOLDOWN_MS     || String(60 * 60 * 1000)); // 60min
const REPOST_URGENT_EV   = parseFloat(process.env.REPOST_URGENT_EV      || '35'); // bypass cooldown
